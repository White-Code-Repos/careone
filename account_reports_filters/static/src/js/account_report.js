odoo.define('account_reports_filters.account_report', function (require) {
    'use strict';
    ...
    accountReportsWidget.include({
        custom_events: {
            'value_changed': function (ev) {
                ...
                self.report_options.analytic_groups = ev.data.analytic_groups;
            ...
            if (this.report_options.analytic) {
                ...
                if (!this.M2MFilters) {
                    ...
                    if (this.report_options.analytic_accounts) {
                        fields['analytic_groups'] = {
                            label: _t('Analytic Groups'),
                            modelName: 'account.analytic.group',
                            value: this.report_options.analytic_groups.map(Number),
                        };
